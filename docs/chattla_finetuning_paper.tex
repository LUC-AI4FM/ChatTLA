% ChatTLA: A Year of Fine-Tuning a 20B Open Model on TLA+
% Companion paper to chattla_paper.tex.
...
deploy, and rollback pipeline, and roughly $480$ verifier-labelled
training examples, the trajectory of the held-out 20-problem benchmark is
